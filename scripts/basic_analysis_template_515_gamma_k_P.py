...
def basic_analysis_template(verbose: bool = False):
    ...
    datas_keywords = [
        ...
        # ["Excitons", "515nm", "Gamma-M", "32.25_32.95eV_CD"],
        # ["Excitons", "515nm", "Gamma-M", "32.85_33.55eV_CD"],
        # ["Excitons", "515nm", "Gamma-M", "33.45_34.15eV_CD"],
    ]
    ...
    for data_keywords in datas_keywords:
        ...
        datas = read_sweep_data(data_root_dir, data_keywords)
        if verbose:
            data_ex = datas[0]
