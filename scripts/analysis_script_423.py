...
import time
from analysis.analysis_tools import read_sweep_data, read_all_sweep_data
...
data_e1 = read_all_sweep_data(
    "/home/shakedr/Downloads/Bi2Se3/Bi2Se3_Nov2025",
    key_words=["423nm", "Gamma_K", "ProbeRotator-37", "eV_0", "31.95eV"],
)
data_e1_c1 = data_e1[0]
data_e1_c2 = data_e1[1]
data_1 = sum_data_sweep(data_e1_c1, data_e1_c2)
print("data 1 energy")
data_e2 = read_all_sweep_data(
    "/home/shakedr/Downloads/Bi2Se3/Bi2Se3_Nov2025",
    key_words=["423nm", "Gamma_K", "ProbeRotator-37", "eV_0", "32.6eV"],
)
data_e2_c1 = data_e2[0]
data_e2_c2 = data_e2[1]
data_2 = sum_data_sweep(data_e2_c1, data_e2_c2)
data_e3 = read_all_sweep_data(
    "/home/shakedr/Downloads/Bi2Se3/Bi2Se3_Nov2025",
    key_words=["423nm", "Gamma_K", "ProbeRotator-37", "eV_1", "33.25eV"],
)
data_e3_c1 = data_e3[0]
data_e3_c2 = data_e3[1]
data_3 = sum_data_sweep(data_e3_c1, data_e3_c2)
data_e4 = read_all_sweep_data(
    "/home/shakedr/Downloads/Bi2Se3/Bi2Se3_Nov2025",
    key_words=["423nm", "Gamma_K", "ProbeRotator-37", "eV_0", "33.9eV"],
)
...
display_pixel_resolved_time_dynamics(
    data,
    bin_params=[9, 3],
    plot_title="Bi2Se3 Gamma-K probe S pump 423nm",
...
data_e2 = read_all_sweep_data(
    "/home/shakedr/Downloads/Bi2Se3/Bi2Se3_Nov2025",
    key_words=["423nm", "Gamma_K", "ProbeRotator-82", "eV_0", "32.6eV"],
)
data_e2_c1 = data_e2[0]
data_e2_c2 = data_e2[1]
data_2 = sum_data_sweep(data_e2_c1, data_e2_c2)
data_e3 = read_all_sweep_data(
    "/home/shakedr/Downloads/Bi2Se3/Bi2Se3_Nov2025",
    key_words=["423nm", "Gamma_K", "ProbeRotator-82", "eV_1", "33.25eV"],
)
data_e3_c1 = data_e3[0]
data_e3_c2 = data_e3[1]
data_3 = sum_data_sweep(data_e3_c1, data_e3_c2)
data_e4 = read_all_sweep_data(
    "/home/shakedr/Downloads/Bi2Se3/Bi2Se3_Nov2025",
    key_words=["423nm", "Gamma_K", "ProbeRotator-82", "eV_0", "33.9eV"],
)
data_e4_c1 = data_e4[0]
data_e4_c2 = data_e4[1]
data_4 = sum_data_sweep(data_e4_c1, data_e4_c2)
...
display_pixel_resolved_time_dynamics(
    data,
    bin_params=[9, 3],
    plot_title="Bi2Se3 Gamma-K probe P pump 423nm",
    plot_excited_levels=True,
    pump_wavelength=423,
    optically_excited_percentile=10,
    log_color_scale=True,
