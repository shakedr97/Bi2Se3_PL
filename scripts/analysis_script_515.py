...
display_pixel_resolved_time_dynamics(
    data,
    bin_params=[9, 3],
    plot_title="Bi2Se3 Gamma-M probe P pump 515nm",
...
display_pixel_resolved_time_dynamics(
    data,
    bin_params=[9, 3],
    plot_title="Bi2Se3 Gamma-K probe P pump 515nm",
    plot_excited_levels=True,
    pump_wavelength=515,
    optically_excited_percentile=10,
)
