...
In the context of ARPES measurements demonstrating behavior of excitons, there is less abundance.
The first excitonic feature that would be visible in an ARPES measurement, is the modified state energy.
As demonstrated in Figure~\ref{fig:exciton_binding_diagram}, an electron photo-emitted from an excitonic state, would appear at an energy slightly lower than an existing electron band~\cite{man2021direct}.
...
In practice there are no evidence for Rydberg series energy levels in ARPES measurements.
